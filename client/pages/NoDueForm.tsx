        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Your no due application has been submitted and is now under
                review
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center space-y-4">
              <Alert className="border-green-200 bg-green-50 text-green-800 dark:border-green-800 dark:bg-green-900 dark:text-green-200">
                ...
                <AlertDescription>
                  You will receive notifications as departments review your
                  application
                </AlertDescription>
              </Alert>
              <Button
        ...
        <div className="max-w-4xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill out all required information for your no due clearance
                application
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {!canApply && (
                  <Alert className="border-yellow-200 bg-yellow-50 text-yellow-800 dark:border-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>
                      You have already submitted an application. Only one
                      application per student is allowed. Please check your
                      dashboard to track your existing application status.
                    </AlertDescription>
                  </Alert>
                )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="idCard">
                        Upload ID Card / Admit Card (Optional)
                      </Label>
                      <Input
                        id="idCard"
                        type="file"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reason">
                      Reason for No Due Certificate (Optional)
                    </Label>
                    <Textarea
                      id="reason"
                      name="reason"
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Status will be updated as departments review your
                    application
                  </p>
                </div>
